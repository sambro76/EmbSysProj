 ...
 *Author:
 *  Samnang Chay
 *  Reference: github.com/kriswiner
 */
#ifndef MPU9250_H_
#define MPU9250_H_
...
/*MPU9250 ID when AD0 is connected to ground*/
#define MPU9250             0x68
...
bool magCalMPU9250(float * mag_bias, float * mag_scale, float * magCalibration);
...
void trigger();
void hysteresis(int THLD);

void storeAccel(char* accel);
